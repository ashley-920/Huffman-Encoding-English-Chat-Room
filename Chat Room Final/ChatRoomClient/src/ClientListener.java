...
public class ClientListener extends Thread {
    ...
    public void checkMsgFromServer(Message msg) {
        ...
        if(sender!=null&&sender.equals(loginScreen.userName)==false)this.playSound();
        switch (type) {
            case 0:
            ...
            case 1:
                ...
                ClientScreen.updateMsgScreen("<b>[" + sender + "]:</b> " + text + "<br>");
                if (mode == 2 && (!sender.equals(loginScreen.userName))) {
                    if (sendingTo.equals("Not Selected")) {
                        this.sendAutoReply(mode);
                    } else {
                        this.sendAutoReply(mode, sendingTo);
                    }
                }
                break;
            case 2:
                ...
                ClientScreen.updateMsgScreen("<font color=red size=4><b>[" + sender + "]:</b> " + text + "</font><br>");
//                String msgderiect="";
            ...
            public void run() {
                try {
                    ...
                    AudioInputStream inputStream = AudioSystem.getAudioInputStream(
                            Main.class.getResourceAsStream("/resorce/sound.wav"));
